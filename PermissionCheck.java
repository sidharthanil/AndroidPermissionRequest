package com.irisind.beatmap_release.Utilities;
...
/*  Add this code block to your activity class from where permission is requesting.
    Im only showing one example. Add in the same pattern for other requests in the switch statement
    and a static function for the same in above code
